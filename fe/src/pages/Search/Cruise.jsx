...
function Cruise() {
  ...
  const [greaterDefaultPrice, setGreaterDefaultPrice] = useState(null);
  const [lowerDefaultPrice, setLowerDefaultPrice] = useState(null);
