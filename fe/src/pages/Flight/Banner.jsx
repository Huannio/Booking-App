...
const Banner = () => {
  // Default form values with today's date as default
  const defaultValues = {
    tripType: 'oneWay',
  ...
  // Set return date to next day when departure date changes in round trip
  useEffect(() => {
    if (tripType === 'roundTrip' && departureDate && !watch('returnDate')) {
      const nextDay = new Date(departureDate);
      nextDay.setDate(nextDay.getDate() + 1);
      setValue('returnDate', nextDay);
    }
                ...
                <div className={cx("flex", "flex-col", "gap-16", "gray-900")}>
                  ...
                  <div className={cx("FlightSearchBox-grid", "FlightSearchBox-distance")}>
                    <div className={cx("FlightSearchBox-selectInput")}>
                      <div>
                        <label htmlFor="departureInput" className={cx("Input-input-group")}>
                          ...
                          />
                          <label htmlFor="departureInput" className={cx("sm", "label-input")}>Điểm đi</label>
                        </label>
                      </div>
                    </div>
                    ...
                    <div className={cx("FlightSearchBox-selectInput")}>
                      <div>
                        <label htmlFor="arrivalInput" className={cx("Input-input-group")}>
                          <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
                          ...
                          <label htmlFor="arrivalInput" className={cx("sm", "label-input")}>Điểm đến</label>
                        </label>
                      </div>
                    </div>
                  </div>
                    ...
                    <div className={cx("DatePicker-mixi-date-picker")}>
                      <div className={cx("react-datepicker-wrapper")}>
                        <div className={cx("react-datepicker", "input-container")}>
                          <div>
                            <label htmlFor="departureDatePicker" className={cx("Input-input-group")}>
                              <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                              ...
                              />
                              <label htmlFor="departureDatePicker" className={cx("sm", "label-input")}>Ngày đi</label>
                            </label>
                          </div>
                        </div>
                      </div>
                    ...
                    {tripType === 'roundTrip' && (
                      <div className={cx("DatePicker-mixi-date-picker")}>
                        <div className={cx("react-datepicker-wrapper")}>
                          <div className={cx("react-datepicker", "input-container")}>
                            <div>
                              <label htmlFor="returnDatePicker" className={cx("Input-input-group")}>
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                                  <path d="M3 9H21M7 3V5M17 3V5M6 12H10V16H6V12ZM6.2 21H17.8C18.9201 21 19.4802 21 19.908 20.782C20.2843 20.5903 20.5903 20.2843 20.782 19.908C21 19.4802 21 18.9201 21 17.8V8.2C21 7.07989 21 6.51984 20.782 6.09202C20.5903 5.71569 20.2843 5.40973 19.908 5.21799C19.4802 5 18.9201 5 17.8 5H6.2C5.0799 5 4.51984 5 4.09202 5.21799C3.71569 5.40973 3.40973 5.71569 3.21799 6.09202C3 6.51984 3 7.07989 3 8.2V17.8C3 18.9201 3 19.4802 3.21799 19.908C3.40973 20.2843 3.71569 20.5903 4.09202 20.782C4.51984 21 5.07989 21 6.2 21Z" stroke="#101828" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
                                </svg>
                                <Controller
                                ...
                                />
                                <label htmlFor="returnDatePicker" className={cx("sm", "label-input")}>Ngày về</label>
                              </label>
                            </div>
                          </div>
                        </div>
                  ...
                  {/* Passenger Selection and Search Button */}
                  <div className={cx("FlightSearchBox-grid")}>
                    <div className={cx("FlightSearchBox-grid")}>
                      <div>
                        <label htmlFor="adultsInput" className={cx("Input-input-group")}>
                          <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                          ...
                          />
                          <label htmlFor="adultsInput" className={cx("sm", "label-input")}>Người Lớn</label>
                        </label>
                      </div>
                      
                      <div>
                        <label htmlFor="childrenInput" className={cx("Input-input-group")}>
                          <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                            <path d="M3 20C5.33579 17.5226 8.50702 16 12 16C15.493 16 18.6642 17.5226 21 20M16.5 7.5C16.5 9.98528 14.4853 12 12 12C9.51472 12 7.5 9.98528 7.5 7.5C7.5 5.01472 9.51472 3 12 3C14.4853 3 16.5 5.01472 16.5 7.5Z" stroke="#101828" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
                          </svg>
                          <Controller
                          ...
                          />
                          <label htmlFor="childrenInput" className={cx("sm", "label-input")}>Trẻ em</label>
                        </label>
                      </div>
                    </div>
                    ...
                    <div className={cx("FlightSearchBox-grid")}>
                      <div>
                        <label htmlFor="infantsInput" className={cx("Input-input-group")}>
                          <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                            <path d="M3 20C5.33579 17.5226 8.50702 16 12 16C15.493 16 18.6642 17.5226 21 20M16.5 7.5C16.5 9.98528 14.4853 12 12 12C9.51472 12 7.5 9.98528 7.5 7.5C7.5 5.01472 9.51472 3 12 3C14.4853 3 16.5 5.01472 16.5 7.5Z" stroke="#101828" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
                          </svg>
                          <Controller
                          ...
                          />
                          <label htmlFor="infantsInput" className={cx("sm", "label-input")}>Em bé</label>
                        </label>
                      </div>
                      
                      <div className={cx("search-button-container")}>
                        <Button primary normal type="submit">
                          Tìm chuyến bay
                        </Button>
                      </div>
                    </div>
