...
import styles from "./PopularSections.module.scss";
import SectionHeader from "~/components/SectionHeader/SectionHeader";
import { handleGetActiveHotelApi } from "~/api";
...
const PopularSections = () => {
  ...
  return (
    <section id={cx("Home-popularSections")}>
      <div className={cx("container", "PopularShips-section")}>
        <SectionHeader
          title={
            <h4>
              Khám phá và trải nghiệm
              <br /> tất cả dịch vụ tuyệt vời nhất
              <br /> từ các khách sạn trên mọi miền
              <br /> đất nước cùng Mixi Vivu.
            </h4>
          }
          mainContent={
        ...
        <div className={cx("PopularShips-action")}>
          <Link to={"/tim-khach-san"}>
            <Button normal outline>
              <div className="label md">Xem tất cả Khách sạn</div>
              <svg
                width="12"
                height="12"
                viewBox="0 0 12 12"
