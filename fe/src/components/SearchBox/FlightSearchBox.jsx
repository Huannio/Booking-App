...
import SearchDatePicker from '../DatePicker/DatePicker';
  ...
  return (
    <form onSubmit={handleSubmit(handleSearchForm)}>
      ...
      >
            ...
            <Controller
              ...
              render={({ field }) => (
                <label className="Checkbox-container">
                  ...
                  />
                  <span className="Checkbox-checkmark Checkbox-sm"></span>
                  <div className="Checkbox-textGroup">
                    <div className="sm Checkbox-title label">Một chiều</div>
                  </div>
                </label>
              )}
            />
            <Controller
              ...
              render={({ field }) => (
                <label className="Checkbox-container">
                  ...
                  <span className="Checkbox-checkmark Checkbox-sm"></span>
                  <div className="Checkbox-textGroup">
                    <div className="sm Checkbox-title label">Khứ hồi</div>
                  </div>
                </label>
              )}
            />
            ...
            render={({ field }) => (
              <label className="Checkbox-container">
                <input 
                  ...
                  checked={field.value}
                />
                <span className="Checkbox-checkmark Checkbox-sm">
                ...
                <div className="Checkbox-textGroup">
                  <div className="sm Checkbox-title label">Vé tháng rẻ nhất</div>
                </div>
              </label>
            )}
          />
        ...
        <div className="FlightSearchBox-grid FlightSearchBox-distance">
          <Controller
            name="departureLoc"
            control={control}
            render={({ field }) => (
              <SearchInputBox
                ...
                reactHookFormChange={field.onChange}
                api={handleSearchFlightsApi}
                fieldDropdown="name"
                fieldDropdownLink="code"
              />
            )}
          />
        ...
        {/* Date Selection */}
        <div className="FlightSearchBox-grid">
          <Controller
            name="departureDate"
            control={control}
            render={({ field }) => (
            ...
            <Controller
              ...
              render={({ field }) => (
                <SearchInputBox
                  ...
                  value={field.value}
                  onChange={(e) => setValue('adults', Math.max(1, parseInt(e.target.value) || 1))}
                />
              )}
            />
            ...
            <Controller
              ...
              render={({ field }) => (
                <SearchInputBox
                  ...
                  value={field.value}
                  onChange={(e) => setValue('children', Math.max(0, parseInt(e.target.value) || 0))}
                />
              )}
            />
          </div>

          <div className="FlightSearchBox_grid">
              ...
              <Controller
                ...
                render={({ field }) => (
                  <SearchInputBox
                    ...
                    value={field.value}
                    onChange={(e) => setValue('infants', Math.max(0, parseInt(e.target.value) || 0))}
                  />
                )}
              />
