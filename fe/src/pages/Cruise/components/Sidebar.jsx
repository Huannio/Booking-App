...
function Sidebar({
  ...
  return (
    <div className={cx(mobile ? `${option}-sidebar-mb` : `${option}-sidebar`)}>
      <div className="Card">
        <div className={cx(`${option}-infoHeader`)}>{infoHeader}</div>
        <div className={cx(`${option}-infoContent`, "flex flex-col gap-16")}>
          {year && (
            <div className="flex gap-24 align-start">
              <div
                className={cx(
                  `${option}-infoContent-label`,
              ...
              >
                ...
                <p className="md">Hạ thủy</p>
              </div>
              <label className="md">{year}</label>
            </div>
          )}
          ...
          {cabin && (
            <div className="flex gap-24 align-start">
              ...
              <label className="md">{cabin}</label>
            </div>
          )}
          ...
          {shell && (
            <div className="flex gap-24 align-start">
              ...
              <label className="md">{shell}</label>
            </div>
          )}
